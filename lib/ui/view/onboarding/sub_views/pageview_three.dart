                              ...
                              children: [
                                Column(
                                  ...
                                  children: const [
                                    ...
                                    Text('0.023 BTC',style: AppStyles.bodyTextStyle,)
                                  ],
                                ),
                                Column(
                                  mainAxisAlignment: MainAxisAlignment.start,
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: const [
                                    Text('10 670 SEK',style: AppStyles.bodyTextStyle,),
                                    Text('+2.1%',style: AppStyles.bodyTextStyle,),
                                  ],
                                ),
                              ],
                            ),
                        ...
                        ListTile(
                          ...
                          title: Row(
                            ...
                            Column(
                              ...
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: const [
                                Text('Ethereum',style: AppStyles.bodyTextStyle,),
                                Text('0.023 ETH',style: AppStyles.bodyTextStyle,),
                              ],
                            ),
                            Column(
                              mainAxisAlignment: MainAxisAlignment.start,
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: const [
                                Text('5000 SEK',style: AppStyles.bodyTextStyle,),
                                Text('+2.5%',style: AppStyles.bodyTextStyle,),
                              ],
                            )
                          ]),
                          trailing: const Icon(
